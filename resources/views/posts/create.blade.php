        ...
        <div class="w-4/5 m-auto">
            <form action="/blog" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-12 py-3">
                    ...
                    <input type="text" id="title" name="title" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-200" required placeholder="Title...">
                </div>
                <div class="py-3">
                    <label for="message" class="block mb-3 text-2xl  font-medium text-gray-900">Description</label>
                    <textarea id="message" name="description" rows="4" class="block p-2.5  w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 bg-gray-200" placeholder="Leave a comment..."></textarea>
                </div>
